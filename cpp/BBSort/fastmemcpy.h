#ifndef BBSORT_SOLUTION_FASTMEMCPY_H
#define BBSORT_SOLUTION_FASTMEMCPY_H
//=====================================================================
//
...
static void* memcpy_fast(void *destination, const void *source, size_t size)
{
    ...
    static size_t cachesize = 0x400000; // AMD Ryzen 7 4800H - AMD L2-cache size
...
#endif //BBSORT_SOLUTION_FASTMEMCPY_H
